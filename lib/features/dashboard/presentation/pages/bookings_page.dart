...
import 'package:sajilo_baas/features/booking/domain/entities/booking_filter.dart';
                  ...
                  child: TextField(
                    ...
                    onChanged: (value) {
                      ...
                      ref
                          ...
                          .applyFilter(BookingFilter(query: value));
                    },
                  ),
                ),
              ],
          ...
          Expanded(
            child: SmartRefresher(
              ...
              child: bookingsAsync.when(
                ...
                error: (e, _) =>
                    Center(child: Text('Failed to load bookings: $e')),
                data: (bookings) {
                  if (bookings.isEmpty) {
                    return const Center(
                      child: Text(
